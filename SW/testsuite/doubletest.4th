...
\         0.12  1 August 2015 test D< acts on MS cells of
\               double word
\         0.11  7 April 2015 2VALUE tested
\         0.6   1 April 2012 Tests placed in the public domain.
\               Immediate 2CONSTANTs and 2VARIABLEs tested
\         0.5   20 November 2009 Various constants renamed to
\               avoid redefinition warnings. <TRUE> and
\               <FALSE> replaced with TRUE and FALSE
\         0.4   6 March 2009 { and } replaced with T{ and }T
\               Tests rewritten to be independent of word size
\               and tests re-ordered
\         0.3   20 April 2007 ANS Forth words changed to upper
\               case
\         0.2   30 Oct 2006 Updated following GForth test to
\               include various constants from core.fr
...
\ Also tests the interpreter and compiler reading a double
\ number
\ ------------------------------------------------------------
\ Assumptions and dependencies:
\ - tester.fr, errorreport.fth and utilities.fth have been
...
: d> ( d1 d2 -- flag )
  2 PICK OVER = IF \ MSCs are equal
    ...
    DROP NIP U> EXIT
  THEN
  \ Return a signed comparison of the MSCs
  NIP ROT DROP > ;
...
T{ : dnmp  #8327. $-2cbe. %011010111. ;
   dnmp -> 8327. -11454. 215. }T
...
\ D2/ is not supported by Z79Forth
\ T{ 0. D2/ -> 0. }T
\ T{ 1. D2/ -> 0. }T
...
\ T{ MIN-2INT LO-2INT NIP 1+ DUP 1- NEGATE M*/
\    -> 0 MAX-INTD 1- }T
